...
<div className='flex flex-col gap-y-3  relative mt-[-140px]  '>
      ...
      {/*   <div className='pl-[20px] overflow-hidden w-[100%] pr-0 flex items-center'>
        ...
        className=' h-[400px] items-center my-custom-swiper  overflow-visible flex'
        >
              <div className='pl-[20px] overflow-hidden w-[100%] pr-0 flex items-center'>
            ...
            {movieData.map((item, index)=> (
                ...
                <SwiperSlide key={index} className=' h-[400px] -z-[999] hover:-z-50 custom-slide whitespace-nowrap flex items-center '
                style={{
                    width: '13px', // Adjust the width to accommodate your images
