...
const TopPicksItem = ({index}) => {
  ...
  return (
    <>
      ...
      className={` whitespace-nowrap -mr-[46px] flex flex-row -z-40 transition-transform    transform  ${isHovered === index ? "hovered": ""}`}
      >
        ...
        {isHovered === index && (
          <div className="absolute inset-0  bg-blue-200 text-white flex flex-col justify-center items-center transition-transform z-[999] hover:rounded-lg w-[320px] h-[300px] rounded-lg ease-in-out duration-300 transform cursor-pointer delay-100 -top-10">
